...
class UpcomingFragment : Fragment() {
    ...
    private lateinit var adapter: EventAdapter // Initialize adapter
    ...
    override fun onCreateView(
        ...
        // Initialize the apiService (adjust based on your setup)
        apiService = ApiService.create() // Assuming you have a create() method to instantiate ApiService
        ...
        adapter = EventAdapter { event ->
            // Navigasi ke EventDetailActivity
            val action = R.id.action_upcomingFragment_to_eventDetailActivity // Menggunakan Safe Args
        ...
        viewModel.eventList.observe(viewLifecycleOwner) { eventResponse ->
